...
impl UiRenderer {
    ...
    fn draw_smooth_diamond_outline(
        ...
        self.draw_thick_line(vertices, indices, index_offset, top, right, thickness, color);
        self.draw_thick_line(vertices, indices, index_offset, right, bottom, thickness, color);
        self.draw_thick_line(vertices, indices, index_offset, bottom, left, thickness, color);
    ...
    fn generate_toolbar(
        ...
        let toolbar_center = [
            screen_size.0 / 2.0,
            titlebar_padding + toolbar_padding + toolbar_height / 2.0,
        ];
